...
Todos los modelos han sido entrenados y evaluados con el limitado hardware personal (\autoref{sec:hardware_local}), exceptuando el modelo YOLOv12l que demanda el uso de un servidor privado 
