...
\chapter{Experimentación} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\label{Experimentación anexo}

\section{Historial de optimización de hiperparámetros}
\label{sec:Historial de optimización de hiperparámetros}

\section{Hiperparámetros de entrenamiento}
\label{sec:Hiperparámetros de entrenamiento}
