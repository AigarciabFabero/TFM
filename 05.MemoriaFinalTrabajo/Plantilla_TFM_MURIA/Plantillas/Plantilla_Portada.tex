...
{\Large \textbf{Detección de células redondas en un conjunto de imágenes médicas mediante aprendizaje profundo}\\[0.8cm]} %[0.1cm]} 
%{\Large \textbf{Sistema cognitivo para ROS 2\\[2cm]}}
{\Large \textbf{Round Cell Detection in Medical Image Sets Using Deep Learning}\\[1.5cm]} %[0.1cm]} 
