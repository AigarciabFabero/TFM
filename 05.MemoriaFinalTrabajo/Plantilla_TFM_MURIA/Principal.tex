...
\begin{itemize}
  ...
  una alternativa a estos modelos pueden ser los de dos etapas (como \textit{Fast-RCNN}), el cual presenta generalmente mayor \textit{precision} y tiempo de inferencia. Una alternativa a esta línea de investigación es usar detectores basados en Transformers
