...
\begin{figure}[htbp]
  ...
  Las \textit{bounging boxes} corresponden con las células redondas y los círculos rojos con los Anillos de Newton.
\end{figure}
...
(2) Entrenamiento, optimización, validación de modelos YOLO
...
% \section{Entrenamiento, optimización, validación de modelos YOLO}
% \label{sec:YOLO}
% \section{Ensamblado de modelos}
...
\begin{itemize}
  ...
  \item \textbf{Ejecución de la aplicación:} en la carpeta \texttt{04.Codigo/cell\_detection\_App} ejecutar:
    ...
    \end{itemize}
  \item \textbf{Compatibilidad con modelos:} funciona únicamente con modelos de YOLO \cite{ultralytics_models}. 
\end{itemize}
