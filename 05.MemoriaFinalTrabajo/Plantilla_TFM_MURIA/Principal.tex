...
Aquí habla de la metodología de Scrum de Indice a lidia.
...
\begin{description}
  ...
  \item[\textit{Time} (s)] Es el tiempo total (en segundos) que tarda el modelo en procesar un conjunto de test. 
...
\resizebox{\textwidth}{!}{
\arrayrulecolor{gray}
\begin{tabular}{!{\vrule width 1.2pt}l|c|c|c|c|c|c|c!{\vrule width 1.2pt}}
\arrayrulecolor{black}
\specialrule{1.5pt}{0pt}{0pt}
\rowcolor{gray!30}
\textbf{Modelo} & \textbf{Test} & \textbf{Precisión} & \textbf{Recall} & \textbf{mAP@0.5} & \textbf{mAP@0.5:0.95} & \textbf{Time (s)} & \textbf{Inferencia (ms)} \\
\specialrule{1.2pt}{0pt}{0pt}
\arrayrulecolor{gray}
yolov8s & test & 0.857 & 0.839 & 0.926 & 0.705 & 24.528 & \cellcolor{turquoise!30}12.071 \\ \hline
yolov9s & test & 0.850 & \cellcolor{turquoise!30}0.878 & 0.933 & 0.707 & 22.988 & 14.584 \\ \hline
yolov10s & test & 0.854 & 0.862 & 0.928 & 0.702 & \cellcolor{turquoise!30}22.573 & \cellcolor{turquoise!30}11.420 \\ \hline
yolov11s & test & 0.848 & 0.866 & 0.931 & 0.717 & 23.231 & 12.801 \\ \hline
yolov12s & test & \cellcolor{turquoise!30}0.863 & 0.848 & \cellcolor{turquoise!30}0.937 & \cellcolor{turquoise!30}0.741 & 23.239 & 14.244 \\
\arrayrulecolor{black}
\specialrule{1.2pt}{0pt}{0pt}
\arrayrulecolor{gray}
yolov8s & test2 & 0.924 & \cellcolor{turquoise!30}0.938 & 0.969 & 0.553 & \cellcolor{turquoise!30}6.399 & 37.858 \\ \hline
yolov9s & test2 & 0.917 & 0.927 & 0.961 & 0.542 & 7.280 & 35.944 \\ \hline
yolov10s & test2 & 0.956 & 0.898 & 0.962 & \cellcolor{turquoise!30}0.589 & 6.973 & \cellcolor{turquoise!30}12.358 \\ \hline
yolov11s & test2 & 0.929 & 0.917 & 0.964 & 0.534 & 6.894 & 14.967 \\ \hline
yolov12s & test2 & \cellcolor{turquoise!30}0.965 & 0.917 & \cellcolor{turquoise!30}0.975 & 0.556 & 6.940 & 20.254 \\
\arrayrulecolor{black}
\specialrule{1.2pt}{0pt}{0pt}
\arrayrulecolor{gray}
yolov8s & test3 & 0.842 & 0.862 & \cellcolor{turquoise!30}0.937 & 0.700 & 8.550 & 11.314 \\ \hline
yolov9s & test3 & 0.843 & 0.870 & 0.935 & 0.681 & 8.957 & 13.291 \\ \hline
yolov10s & test3 & \cellcolor{turquoise!30}0.873 & 0.826 & 0.926 & 0.667 & \cellcolor{turquoise!30}8.311 & \cellcolor{turquoise!30}11.109 \\ \hline
yolov11s & test3 & 0.855 & \cellcolor{turquoise!30}0.874 & 0.935 & 0.698 & 8.541 & 12.561 \\ \hline
yolov12s & test3 & 0.836 & 0.821 & 0.922 & \cellcolor{turquoise!30}0.723 & 8.716 & 15.442 \\
\arrayrulecolor{black}
\specialrule{1.5pt}{0pt}{0pt}
\end{tabular}
}
...
\label{sec:Forma de seguimiento}

\section{Planificación inicial}
\label{sec:Planificación inicial}

\section{Planificación final}
\label{sec:Planificación final}
